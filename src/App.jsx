    ...
    <div className="page auth-page">
      <div className="auth-card settings-card">
        ...
        <div className="form-group">
          ...
          <p className="field-hint">These settings determine how the app navigates you.</p>
          <DisabilitySelector disabilities={disabilities} onChange={setDisabilities} />
        </div>
...
function MainScreen({ user, profile, onNavigate, onLogout }) {
  ...
  return (
    <div className="page main-page">
      ...
      {/* MAP */}
      {mapMode === 'navigate' && <MapView3D profile={profile} mode="navigate" />}
  ...
  return (
    <>
      ...
      {currentPage === 'main' && currentUser && (
        <MainScreen user={currentUser} profile={userProfile} onNavigate={setCurrentPage} onLogout={handleLogout} />
      )}
